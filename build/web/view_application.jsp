<%-- 
    ...
    Created on : 23 Mar, 2017, 5:59:42 PM
    Author     : Akshay
--%>
...
<body>
  ...
  <div class="row">
      ...
      <div class="jumbotron">
        <div class="row text-center">
          <div class="text-center col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <form action="application_select.jsp"  role="form" id="feedbackForm" class="text-center">
    ...
    <div class="form-group" align="left">
        ...
        ResultSet rs=stmt.executeQuery("select no from application where status=1 order by no");
       while(rs.next()){
            %>
        <option value ="<%=rs.getString(1)%>"><%=rs.getString(1)%></option>
          ...
          <iframe src="application_table.jsp" height="200" width="100%" 
                align="center"></iframe>
        </div>
      </div>
    </div>
