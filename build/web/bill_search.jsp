<%-- 
    Document   : bill_search
    Created on : 24 Apr, 2017, 10:05:23 AM
    Author     : Akshay
--%>
...
<body>
  ...
  <div class="row">
    ...
    <table align="center" style="width:100%" >
       ...
       <%
           int billnum=Integer.parseInt(request.getParameter("bill_no"));
           
               try{
        Class.forName("com.mysql.jdbc.Driver");
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/cloud_hostel","root","ak47");
        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery("select * from bill where billnum="+billnum+"");
       while(rs.next())
       {
           %>
           <tr>
